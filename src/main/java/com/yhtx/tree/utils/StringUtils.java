...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     * @return
     */
    public static Double TwoNumberDivision(Integer Dividend,Integer Divisor){
     ...
     * @return
     */
    public static Double TwoNumberDivision(Long Dividend,Long Divisor){
        if(Dividend==null || Divisor==null){
            return 0D;
        }
        if(Divisor==0){
     ...
     * @return
     */
    public static Integer ToLong(Long Source){
    ...
    //移除最后一位字符标点
    public static String removeLast(String content){
